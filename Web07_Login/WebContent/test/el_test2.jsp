...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    /*
		...
		requset scope 에 담은 값은 응답하기 전까지 사용할 수 있다.
    ...
    */
    ...
    String ourName="원숭이";
    /*
    	session scope 에 "ourName"이라는 키값으로 ourName담기
    	session scope 에 담은 값은 세션이 유지되는 동안 사용할 수 있다.
    	(다른 페이지로 forward, redirect 이동해도 사용할 수 있다.)
    ...
    */
    ...
    dto.setContent("놀자~~");
    /*
    	request영역에 "dto"라는 키값으로 CafeDto type인 dto담기
    */
