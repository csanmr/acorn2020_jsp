...
<head>
<meta charset="UTF-8">
<title>/test/regular_ex.jsp 정규표현식</title>
</head>
<body>
...
<script>
	...
	var reg1=/^[a-z]/;
	//최소 5글자 최대 10글자인지 여부를 검증할 수 있는 정규 표현식 객체
	var reg2=/^.{5,10}$/;
	//특수 문자가 포함되어 있는지 여부를 검증할 수 있는 정규 표현식 객체
	var reg3=/[^a-zA-Z0-9]/;
	...
	$("#checkBtn").on("click",function(){
		...
		if(!reg4.test(str)){
			alert("영문자 소문자로 시작을 하고 최소 5글자~최대10글자 이내로 작성해주세요!");
		}
	});
