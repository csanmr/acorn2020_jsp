...
<div class="container">
	...
	<div class="form-group">
		...
		<input class="form-control is-invalid" type="text" id="id" name="id" placeholder="아이디 입력..."/>
		<div class="invalid-feedback" id="idFeedback">영문자 소문자로 시작을 하고 최소 5글자에서 최대 10글자 이내로 작성하세요</div>
	</div>
	<div class="form-group">
		<label for="phone">휴대폰 번호</label>
		<input class="form-control" type="text" id="phone" name="phone" placeholder="010-1111-2222"/>
		<div class="invalid-feedback" id="phoneFeedback">휴대폰 번호 형식에 맞게 입력 하세요.</div>
	</div>
